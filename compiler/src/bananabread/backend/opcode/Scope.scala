...
class Scope(val module: String, env: Map[String, Ir], parent: Option[Scope]):
  ...
  def contains(id: stitched.Id): Boolean = contains(id.expr.lexeme)
  ...
  def get(id: stitched.Id): Option[Ir] = get(id.expr.lexeme)
  ...
  def qualified(id: stitched.Id): String = qualified(id.expr.lexeme)
  ...
  def qualified2(id: stitched.Id): Option[String] = qualified2(id.expr.lexeme)
  ...
  def define(id: stitched.Param, ir: Ir): Unit = define(id.name.lexeme, ir)
  def define(id: stitched.Id, ir: Ir): Unit = define(id.expr.lexeme, ir)
