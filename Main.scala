...
def main(args: Array[String]) =
  ...
  println(parse("<stdin>", "*a * *b", syntax)) // TODO: uniops should be grouped with operands, Right(List((* (* a (* b)))))
  ...
  println(parse("<stdin>", "+(1, *(2, 3))", syntax).map(ir1.lift)) // TODO: Left(UnexpectedTokenErr(COMMA))
